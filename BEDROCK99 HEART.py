...
#PAROIMIES============================================================================================================================================
ΠΑΡΟΙΜΙΕΣ = ('''Όσα δε φτάνει η αλεπού, τα κάνει κρεμαστάρια.
...
"Never mind the time," said Inspector Dutruelle with as much irritation as his whispering voice could convey. "I'm off duty 
...
BEDROCK99 = ("I AM NOT AN IDIOT! I AM NOT USING MY OLD NAME AS A PASSWORD!!!")




storyforkids1 = ('''
By the African river, know as the Nill
...
To feed on the grass by the river once moreThey dried off their bodies by shaking and stomping
...
print ("BEDROCK99 HEART IS THE HEART OF BEDROCK YOUTUBERS CR! IF IT BROKE, BEDROCK99 FALLS DOWN AND IT WILL BE BE DESTROYED IF SOMETHING HAPPEN TO THE HEART")
print ("Oταν ειναι το heart ανοιχτο,μονο τοτε μπορεις να το χρησιμοποιησεις.αλλα οταν ειναι κλειστο,παλι δεν παθαινει τιποτα η bedrock youtubers cr")


print ("WRITE ΠΟΙΗΜΑ για να δεις ενα ΠΟΙΗΜΑ")
print ("writeTHECRAFTERS to see heart crafters ")
print ('ΣΤΟ ΗEART Eisai safe!!!' )
print('write GAME1 to play game 1')
print ("write GAME2 TO PLAY game 2")
print ("write storyforkids1 to read a story for kids")
print ("write VAULT to go to the vault")
print ('WRITE STORY TO SEE A STORY')
print ("WRITE ΠΑΡΟΙΜΙΕΣ ΓΙΑ ΝΑ ΔΙΑΒΑΣΕΙΣ ΜΕΡΙΚΕΣ ΠΑΡΟΙΜΙΕΣ")
print ("write ΜΕΡΗΤΗΣΚΑΡΔΙΤΣΑΣ ΤΟ SEE SOME OF THE PLACES IN KARDITSA")
...
GAME1 =('GAME IS A GREAT BUILT-IN GAME WHICH CAN BE PLAYED NOW AND IT IS A QUIZ!  .........GAME STARTED!     OK, LETS GO!!!  DO YOU LIKE CHEESE; SAY YES OR NO')

NO = ('REALLY, OK! DO YOU LIKE BACON SAY IDONT OR OFCOURSE')



YES = ('I LIKE IT TO! DO YOU LIKE BACON SAY OFCOURSE OR IDONT')


IDONT = ('OK, THEN DO YOU LIKE PIZZA ; SAY YEAH OR NOT')
 

OFCOURSE = ('I LOVE IT ! DO YOU LIKE PIZZA; SAY YEAH OR NOT')


NOT =('OK; YOU WAS GREAT!!! GAME IS COMPLETED')



YEAH = ('PIZZA IS THE BEST!!!GAME ENDED!')

#GAME2===================================================================================================================================================
GAME2 = ('''GAME2 IS A GREAT BUILT-IN GAME WHICH CAN BE PLAYED NOW AND IT IS AN OTHER QUIZ!....................................GAME STARTED! DO YOU LIKE ATTACKING OTHER PLAYERS IN GAMES; SAY YES OR NO2''')

NO2 = ('ME TO! ARE YOU PLAYING MINECRAFT SAY NO4 OR YES4')

YES2 = ('ME TO!!! ARE YOU PLAYING BRAWL STARS; SAY NO3 OR YES3')




YES3 = ('ME TO! GAME ENDED!!!!!!!!!!!!')


NO3 = ("I AM!!! GAME ENDED!!!!!!!!!!!!!!!!!")

 
NO4 = ('IT IS A PERFECT GAME!! YOU SHOULD BUY IT!!!GAME ENDED!!!!!!!!!!!!!!!')

YES4 = ('OK!!! GAME ENDED!!!!!!!!!!!!!!')

#VAULT===============================================================================================================================================

VAULT = (' which is the password')



BEDME3 = ('''ACCESS GRANTED! YOU ARE IN THE VAULT!!!
DO YOU WANT TO SEE THE PASSWORD AGAIN; SAY OKAY OR IMNOTSURE!
DO YOU WANNA SEE ALL THE INFORMATION ABOUT BEDROCK youtubers cr; SAY YEET OR YAYEET!!! YEET IS YES AND YAYEET IS NO.
DO YOU WANNA DELETE THE PROJECT; SAY NOPE AND NOPEE! NOPE=YES AND NOPEE = NO
...
IMNOTSURE = (' OKAY...')
OKAY = ("BEDROCK98")
NOPE = ('WHAT IS MY LOGO;')
NOPEE = ('OK')

RESUME = ("RESUMED")
YAYEET = ('OK THEN...')
YEET = ("BEDROCK99 IS AN XBOX CLUB TOO! WE ARE ACHIVEMENT HUNTERS.THERE IS OUR MICROSOFT CLUB TOO! ALL NAMES ARE BEDROCK99!!!THE HEART RELEASED IN THE SUMMER OF 2019.")
STOP = ("DELETE STOPED")
D = ('WHERE ARE THE CHRISROCK731S HOME;"')
CR = ("WHAT IS THE CLUBS LAST LETTER")
Papaflessa_24 = ('DELETE IN ONE HOUR AND SEVEN MINUTES')
Get_out_of_the_Vault = (' OKAY........................................................................................................................... YOU ARE NOT IN THE VAULT!!!')
...
ΜΕΡΗΤΗΣΚΑΡΔΙΤΣΑΣ = ('''ΖΩΟΛΟΓΙΚΟΙ ΚΗΠΟΙ ΚΑΙ ΕΝΥΔΡΕΙΑ
1. Φιλόνεικος
Πάρκο Παυσίλυπο
ΦΥΣΗ ΚΑΙ ΠΑΡΚΑ
2. Πάρκο Παυσίλυπο
...
ΜΟΥΣΕΙΑ
4. Αρχαιολογικό Μουσείο Καρδίτσας
Fanari Castle
ΜΝΗΜΕΙΣ ΖΩΟΛΟΓΙΚΟΙ ΚΗΠΟΙ ΚΑΙ ΕΝΥΔΡΕΙΑ
1. Φιλόνεικος
Πάρκο Παυσίλυπο
ΦΥΣΗ ΚΑΙ ΠΑΡΚΑ
2. Πάρκο Παυσίλυπο
...
5. Fanari Castle
ΜΟΥΣΕΙΑ
6. Δημοτικη Πινακοθηκη Καρδιτσας
ΜΟΥΣΕΙΑ
7. Φωτοκινηματογραφικό Μουσείο
Φίλια γη
ΦΑΓΗΤΟ ΚΑΙ ΠΟΤΟ
8. Φίλια γη
Baths of  Kaitsa (Loutra Kaitsas)
ΕΥΕΞΙΑ ΚΑΙ ΣΠΑ
9. Baths of Kaitsa (Loutra Kaitsas)
ΠΕΡΙΗΓΗΣΕΙΣ
10. Excursion to Lake Plastira
Α ΚΑΙ ΑΞΙΟΘΕΑΤΑ
5. Fanari Castle
ΜΟΥΣΕΙΑ
6. Δημοτικη Πινακοθηκη Καρδιτσας
...
LERA = ('CHRISROCK731,GREG201O-OR GRIGORIS_GIAN-')
THECRAFTERS = ('THE PASSWORD PLEASE')
               



ΠΟΙΗΜΑ =("γραψε κωδικο του ποιηματος")
